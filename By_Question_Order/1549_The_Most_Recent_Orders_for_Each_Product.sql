1549_The_Most_Recent_Orders_for_Each_Product.sql
...
select
 ...
 o.product_id,
 p.product_name,
 dense_rank() over (partition by o.product_id 
                    order by o.order_date desc) as r
from orders o
left join products p on p.product_id =o.product_id) as t
